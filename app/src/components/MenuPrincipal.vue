    ...
    return {
      ...
      menu: [
        { label: 'Cadastros',
          icon: 'mdi-account',
          submenus: [
            { label: 'Contas', icon: 'mdi-folder-alert', url: '' },
            { label: 'Tipo de Conta', icon: 'mdi-folder-swap', url: '' },
            { label: 'Utilizadores', icon: 'mdi-account-supervisor-circle', url: '' },
            { label: 'Empresa', icon: 'mdi-office-building', url: '' }
          ] },
